	...
	$projetos->set_arguments(
        array(
	        'taxonomies' => array('post_tag'),
		 	'menu_icon' => 'dashicons-screenoptions',
      		'supports' => array( 'title', 'editor', 'thumbnail' ),
			'description' => __( 'A super duper is a projetos of content that is the most wonderful content in the world. There are no alternatives that match how insanely creative and beautiful it is.' ),
...
function jardim_cpt(){
	...
	$jardin->set_labels(
	    array(
			...
			'all_items' => __('Todas os Jardins', 'odin'),
	    	'add_new_item' => __('Adicionar novo', 'odin'),
			'add_new' => __('Adicionar novo', 'odin'),
